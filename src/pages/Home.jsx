...
import img from "../pics/mosquito2.png"
import Team from "../pics/teamlogo.png"
...
const Home = () => {
    ...
    return (
        <div className='bg-red-50' ref={container}>
            ...
            <img src={Team} alt="" className="w-full absolute" />
            <img id="moving" src={img} alt="" className="w-64" />
            ...
            <svg id="svg" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 1860 3600">
                ...
                <path id="path" class="theLine"
                    d="M 903 429 C 899 429 863 735 536 710 C 519 709 506 709 490 711 C 473 714 358.187 718.682 146.249 844.249 C -70.78 1103.95 14.857 1306.805 137.249 1507.249 C 282.515 1612.786 1584.834 1474.822 1710.249 1645.249 C 1835.665 1815.676 1714.757 2171.998 1642.249 2241.249 C 1545.451 2403.675 254.384 2180.83 104.249 2411.249 C -45.885 2641.668 14.421 2845.36 132.249 2966.249 C 250.78 3087.463 1582.519 2858.373 1657.249 3267.249"
                    fill="none" stroke="invisible" stroke-width="10px" />
